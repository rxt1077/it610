...
Follow
http://webcache.googleusercontent.com/search?q=cache:9zx50MkZ8tUJ:www.sj-vs.net/creating-a-simple-debian-deb-package-based-on-a-directory-structure/+&cd=1&hl=en&ct=clnk&gl=us&client=firefox-b-1-d/[this
